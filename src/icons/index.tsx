...
import RoutineIcon from './routine.svg';
...
export default function Icon({ icon, className, rootClassName }: { icon: React.ReactElement<any>; className?: string; rootClassName?: string }) {
    return <span className={rootClassName}>{icon && cloneElement(icon, { className })}</span>;
}
