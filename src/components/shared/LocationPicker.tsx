...
const LocationPicker: React.FC<LocationPickerProps> = ({ onChange, value: cordsString, disabled, height }) => {
    ...
    return (
        <YMaps>
            <Map defaultState={{ center: coords, zoom: 15 }} width="100%" height={height} onClick={handleMapClick}>
                <Placemark
                    geometry={coords}
                    options={{
